...
const Navbar: FC = () => {
  ...
  return (
    <nav className="sticky top-0 z-[1000] col-span-full mb-[0px] flex items-center justify-between gap-2 bg-white px-6 py-4 dark:border-neutral-600 dark:bg-[#161616] md:gap-3 md:py-3 md:px-8">
