...
const Navbar: FC = () => {
  ...
  return (
    <nav className="sticky top-0 z-[1000] col-span-full mb-[10px] flex items-center justify-between gap-2 bg-white px-6 py-4 dark:border-neutral-600 dark:bg-[#161616] md:gap-3 md:py-3 md:px-8">
      <NavbarLogo className="z-10 max-w-[300px] scale" />
      {showLinks && (
      ...
      <div className="z-10 ml-auto hidden shrink-0 md:flex scale md:gap-2">
        <ConnectWallet />
        <ThemeSwitcher />
      </div>
      <CartMenu />
